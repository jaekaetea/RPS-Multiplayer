...
var config = {
    apiKey: "AIzaSyDjUGNWGMcns1m3-QOYAcmM3dKkULYNPIA",
    authDomain: "rps-multiplayer-5b5e0.firebaseapp.com",
    databaseURL: "https://rps-multiplayer-5b5e0.firebaseio.com",
    projectId: "rps-multiplayer-5b5e0",
    storageBucket: "rps-multiplayer-5b5e0.appspot.com",
    messagingSenderId: "657469916653",
    appId: "1:657469916653:web:0a4596dae5aa57e9"
};
  ...
  function gameLogic(player1choice, player2choice) {
    var playerOneWon = function() {
      $("#result").append($("<h3>").text(playerOneData.name + " Wins!"))
      if (playerNum === 1) {
        playersRef
          .child("1")
          .child("wins")
    ...
    var playerTwoWon = function() {
      $("#result").append($("<h3>").text(playerTwoData.name + " Wins!"));
      if (playerNum === 2) {
        playersRef
          .child("2")
          .child("wins")
    ...
    var tie = function() {
        $("#result").append($("<h3>").text("Tie Game!"));
    };
